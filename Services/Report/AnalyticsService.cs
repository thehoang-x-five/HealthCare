...
{
    /// <summary>
    /// Analytics service using MongoDB Aggregation Framework.
    /// Uses "medical_histories" collection (matches MongoHistoryRepository on main).
    ...
    public class AnalyticsService : IAnalyticsService
    {
        ...
        // ============================================================
        // =  1. THỐNG KÊ CHỈ SỐ BẤT THƯỜNG (MongoDB Aggregation)   =
        // ============================================================
        ...
        // ============================================================
        // =  2. XU HƯỚNG BỆNH TẬT ICD-10 (MongoDB Aggregation)     =
        // ============================================================
        ...
        // ============================================================
        // =  3. THUỐC PHỔ BIẾN (SQL — dữ liệu đơn thuốc ở MySQL)   =
        // ============================================================

        public async Task<PopularDrugsDto> GetPopularDrugsAsync(DateTime? fromDate = null, DateTime? toDate = null, int topN = 10)
        {
            // Drug statistics from MySQL (prescription data lives in MySQL, not MongoDB)
