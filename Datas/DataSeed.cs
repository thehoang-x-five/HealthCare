...
namespace HealthCare.Datas
{
            ...
            return new List<Phong>
    {
        ...
        private static List<NhanVienYTe> SeedNhanSu(List<KhoaChuyenMon> khoaList)
        {
            ...
            {
                new NhanVienYTe { MaNhanVien = "NV_BS_TQ_01", TenDangNhap = "bs_tq01", MatKhauHash = hash, HoTen = "BS. Nguyễn Văn A", VaiTro = "bac_si", ChucVu = "bac_si", HocVi = "BS CKI", ChuyenMon = "Khám tổng quát", SoNamKinhNghiem = 5, Email = "bs_tq01@hospital.local", DienThoai = "0903000001", MaKhoa = "KHOA_TQ", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_BS_TQ_02", TenDangNhap = "bs_tq02", MatKhauHash = hash, HoTen = "BS. Trần Thị B", VaiTro = "bac_si", ChucVu = "bac_si", HocVi = "BS CKI", ChuyenMon = "Khám tổng quát", SoNamKinhNghiem = 7, Email = "bs_tq02@hospital.local", DienThoai = "0903000002", MaKhoa = "KHOA_TQ", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_BS_NOI_01", TenDangNhap = "bs_noi01", MatKhauHash = hash, HoTen = "BS. Phạm Văn C", VaiTro = "bac_si", ChucVu = "bac_si", HocVi = "BS CKII", ChuyenMon = "Nội tổng quát", SoNamKinhNghiem = 10, Email = "bs_noi01@hospital.local", DienThoai = "0903000003", MaKhoa = "KHOA_NOI", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_BS_NGOAI_01", TenDangNhap = "bs_ngoai01", MatKhauHash = hash, HoTen = "BS. Lê Thị D", VaiTro = "bac_si", ChucVu = "bac_si", HocVi = "BS CKI", ChuyenMon = "Ngoại tổng quát", SoNamKinhNghiem = 8, Email = "bs_ngoai01@hospital.local", DienThoai = "0903000004", MaKhoa = "KHOA_NGOAI", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_BS_NHI_01", TenDangNhap = "bs_nhi01", MatKhauHash = hash, HoTen = "BS. Nguyễn Thị E", VaiTro = "bac_si", ChucVu = "bac_si", HocVi = "BS CKI", ChuyenMon = "Nhi", SoNamKinhNghiem = 6, Email = "bs_nhi01@hospital.local", DienThoai = "0903000005", MaKhoa = "KHOA_NHI", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_BS_SAN_01", TenDangNhap = "bs_san01", MatKhauHash = hash, HoTen = "BS. Đỗ Văn F", VaiTro = "bac_si", ChucVu = "bac_si", HocVi = "BS CKI", ChuyenMon = "Sản", SoNamKinhNghiem = 9, Email = "bs_san01@hospital.local", DienThoai = "0903000006", MaKhoa = "KHOA_SAN", TrangThaiCongTac = "dang_cong_tac" },

                new NhanVienYTe { MaNhanVien = "NV_YT_HC_01", TenDangNhap = "yt_hc01", MatKhauHash = hash, HoTen = "ĐD. Hồ Thị G", VaiTro = "y_ta", ChucVu = "y_ta_hanh_chinh", LoaiYTa = "hanhchinh", SoNamKinhNghiem = 4, Email = "yt_hc01@hospital.local", DienThoai = "0903000011", MaKhoa = "KHOA_TQ", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_YT_LS_01", TenDangNhap = "yt_ls01", MatKhauHash = hash, HoTen = "ĐD. Bùi Văn H", VaiTro = "y_ta", ChucVu = "y_ta_lam_sang", LoaiYTa = "ls", SoNamKinhNghiem = 5, Email = "yt_ls01@hospital.local", DienThoai = "0903000012", MaKhoa = "KHOA_NOI", TrangThaiCongTac = "dang_cong_tac" },
                new NhanVienYTe { MaNhanVien = "NV_YT_CLS_01", TenDangNhap = "yt_cls01", MatKhauHash = hash, HoTen = "ĐD. Lý Thị I", VaiTro = "y_ta", ChucVu = "y_ta_can_lam_sang", LoaiYTa = "cls", SoNamKinhNghiem = 3, Email = "yt_cls01@hospital.local", DienThoai = "0903000013", MaKhoa = "KHOA_XN", TrangThaiCongTac = "dang_cong_tac" },
