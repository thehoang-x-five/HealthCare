    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiaChi = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaCha = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaMe = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    NgayCapNhat = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ...
                    BenhNhanMaBenhNhan = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_benh_nhan_benh_nhan_BenhNhanMaBenhNhan",
                        column: x => x.BenhNhanMaBenhNhan,
                        principalTable: "benh_nhan",
                        principalColumn: "MaBenhNhan");
                    table.ForeignKey(
                        name: "FK_benh_nhan_benh_nhan_MaCha",
                        column: x => x.MaCha,
                        principalTable: "benh_nhan",
                        principalColumn: "MaBenhNhan",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_benh_nhan_benh_nhan_MaMe",
                        column: x => x.MaMe,
                        principalTable: "benh_nhan",
                        principalColumn: "MaBenhNhan",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaMau = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TenMau = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NoiDungMau = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BienDong = table.Column<string>(type: "json", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NgayTao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    NgayCapNhat = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_thong_bao_mau", x => x.MaMau);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThoiGianThanhToan = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ThoiGianPhat = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    MaNhanSuPhat = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NgayTao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    NgayCapNhat = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LieuDung = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TanSuatDung = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                name: "lich_su_xuat_kho",
                columns: table => new
                {
                    MaGiaoDich = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaThuoc = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaDonThuoc = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaNhanSuXuat = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LoaiGiaoDich = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SoLuong = table.Column<int>(type: "int", nullable: false),
                    SoLuongConLai = table.Column<int>(type: "int", nullable: false),
                    ThoiGianXuat = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    GhiChu = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_lich_su_xuat_kho", x => x.MaGiaoDich);
                    table.ForeignKey(
                        name: "FK_lich_su_xuat_kho_don_thuoc_MaDonThuoc",
                        column: x => x.MaDonThuoc,
                        principalTable: "don_thuoc",
                        principalColumn: "MaDonThuoc",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_lich_su_xuat_kho_kho_thuoc_MaThuoc",
                        column: x => x.MaThuoc,
                        principalTable: "kho_thuoc",
                        principalColumn: "MaThuoc",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_lich_su_xuat_kho_nhan_vien_y_te_MaNhanSuXuat",
                        column: x => x.MaNhanSuXuat,
                        principalTable: "nhan_vien_y_te",
                        principalColumn: "MaNhanVien",
                        onDelete: ReferentialAction.Restrict);
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaChiTietDv = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LoaiKetQua = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NoiDungKetQua = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    KetLuanChuyen = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GhiChu = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TepDinhKem = table.Column<string>(type: "json", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThoiGianChot = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaChiTietDv = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SoLanGoi = table.Column<int>(type: "int", nullable: false),
                    ThoiGianGoiGanNhat = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    NgayTao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    NgayCapNhat = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThoiGianThucTe = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    SinhHieuTruocKham = table.Column<string>(type: "json", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoTienPhaiTra = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    MaGiaoDich = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    NoiDung = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThoiGianHuy = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    MaNhanSuHuy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChanDoanCuoi = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MaICD10 = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    PhatDoDieuTri = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NgayTaiKham = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    GhiChuTaiKham = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThoiGianTao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ThoiGianCapNhat = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_benh_nhan_BenhNhanMaBenhNhan",
                table: "benh_nhan",
                column: "BenhNhanMaBenhNhan");

            migrationBuilder.CreateIndex(
                name: "IX_benh_nhan_CCCD",
                table: "benh_nhan",
                column: "CCCD",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_benh_nhan_MaCha",
                table: "benh_nhan",
                column: "MaCha");

            migrationBuilder.CreateIndex(
                name: "IX_benh_nhan_MaMe",
                table: "benh_nhan",
                column: "MaMe");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lich_su_xuat_kho_MaDonThuoc",
                table: "lich_su_xuat_kho",
                column: "MaDonThuoc");

            migrationBuilder.CreateIndex(
                name: "IX_lich_su_xuat_kho_MaNhanSuXuat",
                table: "lich_su_xuat_kho",
                column: "MaNhanSuXuat");

            migrationBuilder.CreateIndex(
                name: "IX_lich_su_xuat_kho_MaThuoc",
                table: "lich_su_xuat_kho",
                column: "MaThuoc");
